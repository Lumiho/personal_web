        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <Reveal key={project.id} delay={index * 100} className="h-full">
              <div className="h-full flex flex-col bg-gray-50 border-t-4 border-sacramento-600 rounded-xl shadow-sm hover:shadow-xl transition-shadow duration-300 p-6">
                <div className="mb-3">
